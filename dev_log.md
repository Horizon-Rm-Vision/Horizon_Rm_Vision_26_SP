...
- **质量更新:**
  1.标定手册V2版本，修正了部分错误内容
  2.将DM_IMU的代码加入LIM_CODE编译限制，屏蔽其依赖库serial文件夹，并将与其相关的mt_standard、standard_mpc、uav、uav_debug、dm_test、minium_vision_system在cmake中注释禁止编译
- **已验证:**
