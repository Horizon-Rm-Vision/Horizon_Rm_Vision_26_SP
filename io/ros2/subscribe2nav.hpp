...
public:
  ...
  std_msgs::msg::Int8 subscribe_buff();
...
private:
  ...
  void buff_callback(const std_msgs::msg::Int8::SharedPtr msg);
  ...
  rclcpp::TimerBase::SharedPtr buff_timer_;
  ...
  rclcpp::Subscription<std_msgs::msg::Int8>::SharedPtr buff_subscription_;
  ...
  tools::ThreadSafeQueue<std_msgs::msg::Int8> buff_queue_;
